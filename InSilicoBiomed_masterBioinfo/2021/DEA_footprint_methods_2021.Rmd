...
knitr::opts_knit$set(root.dir = '~/Projects/teaching/teaching_material/InSilicoBiomed_masterBioinfo_2021' )
```
...
```{r inverse_carnival, cache=T, eval=F, results=F, message=F}
